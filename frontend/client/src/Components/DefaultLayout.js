...
import { faBowlFood, faHouse, faMoneyBills, faUser, faArrowRightFromBracket, faCartShopping} from "@fortawesome/free-solid-svg-icons";
    ...
    <Layout>
      ...
      >
        ...
        >
          ...
          <Menu.Item key="/bills" icon={<FontAwesomeIcon icon={faMoneyBills} />}>
